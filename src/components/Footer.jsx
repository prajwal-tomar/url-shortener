...
const Footer = () => {
  return (
    <div className="bg-slate-800 flex justify-evenly items-start py-10 text-slate-300 text-sm">
      <img src={logo} alt="logo" />
      <ul className="space-y-2">
        <li className="text-white pb-3 hover:cursor-default">Features</li>
      ...
      <ul className="space-y-2">
        <li className="text-white pb-3 hover:cursor-default">Resources</li>
      ...
      <ul className="space-y-2">
        <li className="text-white pb-3 hover:cursor-default">Company</li>
